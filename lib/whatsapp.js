...
// Send Flow via approved template (works for all users anytime)
async function sendFlowTemplate(to, { templateName, language = "en" }) {
  console.log("Sending Flow Template:", templateName, "to:", to);
  return apiCall({
    to,
    type: "template",
    template: {
    ...
    interactive: {
      ...
      action: {
        ...
        parameters: {
          ...
          url: `https://wa.me/c/917771000404`,
        },
      },
    },
  });
...
module.exports = {
  ...
  sendFlow, sendFlowTemplate, sendCatalogLink,
};