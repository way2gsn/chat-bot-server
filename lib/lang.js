...
const UI = {
  ...
  hi: {
    welcome:        "Agri Fresh Store में आपका स्वागत है 🌾\nखेत से ताजा उत्पाद आपके दरवाजे तक!",
    choose:         "आज हम आपकी कैसे मदद कर सकते हैं?",
    menu_btn:       "जारी रखने के लिए चुनें",
  ...
  ta: {
    welcome:        "Agri Fresh Store-க்கு வரவேற்கிறோம் 🌾\nபண்ணை புதிதாக, உங்கள் வீட்டிற்கு!",
    choose:         "இன்று நாங்கள் எப்படி உதவலாம்?",
    menu_btn:       "தொடர தேர்வு செய்யவும்",
  ...
  te: {
    welcome:        "Agri Fresh Store కి స్వాగతం 🌾\nపొలం నుండి తాజాగా మీ ఇంటికి!",
    choose:         "ఈరోజు మేము ఎలా సహాయపడగలం?",
    menu_btn:       "కొనసాగడానికి ఎంచుకోండి",
