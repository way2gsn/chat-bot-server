...
const UI = {
  en: {
    welcome:        "🌾 Welcome to Phasal Bazar! 🌾\nWe bring 100% natural, farm-fresh, and pure products directly from our fields to your kitchen.\n🌐 Explore our D2C store: https://phasalbazar.com",
    choose:         "How would you like to shop today? Please choose an option:",
    menu_btn:       "View",
    shop:           "🛒 Shop Products",
  ...
  hi: {
    welcome:        "🌾 *Phasal Bazar में आपका स्वागत है!* 🌾\n\nहम सीधे खेतों से 100% प्राकृतिक और शुद्ध उत्पाद आपके घर तक लाते हैं।\n\n🌐 विशेष ऑफर्स के लिए हमारी वेबसाइट देखें: https://phasalbazar.com",
    choose:         "आप आज कैसे खरीदारी करना चाहेंगे? कृपया एक विकल्प चुनें:",
    menu_btn:       "देखें",
  ...
  ta: {
    welcome:        "🌾 *Phasal Bazar-க்கு வரவேற்கிறோம்!* 🌾\n\n100% இயற்கையான மற்றும் தூய்மையான தயாரிப்புகள் நேரடியாக எங்கள் வயல்களில் இருந்து உங்கள் வீட்டிற்கு.\n\n🌐 எங்கள் வலைத்தளத்தைப் பார்க்கவும்: https://phasalbazar.com",
    choose:         "இன்று நீங்கள் எவ்வாறு வாங்க விரும்புகிறீர்கள்? கீழே தேர்ந்தெடுக்கவும்:",
    menu_btn:       "தேர்வு",
  ...
  te: {
    welcome:        "🌾 *Phasal Bazar కి స్వాగతం!* 🌾\n\n100% సహజమైన మరియు స్వచ్ఛమైన ఉత్పత్తులను నేరుగా మా పొలాల నుండి మీ ఇంటికి తీసుకువస్తాము.\n\n🌐 మా వెబ్‌సైట్‌ను సందర్శించండి: https://phasalbazar.com",
    choose:         "ఈరోజు మీరు ఎలా కొనాలనుకుంటున్నారు? దయచేసి ఎంచుకోండి:",
    menu_btn:       "ఎంచుకోండి",
